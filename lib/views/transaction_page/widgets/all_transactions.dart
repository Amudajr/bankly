...
import 'package:bankly/views/transaction_page/transction_detail_page.dart';
...
class AllTransactionsCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<TransactionsModel>>(
        future: TransactionsViewModel.getTransactions(query, filter),
                ...
                itemBuilder: (context, index) {
                  ...
                  return InkResponse(
                    ...
                    child: Row(
                      ...
                      children: [
                        transaction.trnDrCr == 'deposit'
                            ? SvgPicture.asset(credit)
                            : SvgPicture.asset(debit),
                        20.pw,
                        Column(
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            ...
                            fontWeight: FontWeight.w500,
                            color:
                                transaction.trnDrCr == 'deposit' ? GREEN : RED,
                          ),
                        ),
                      ],
                    ),
